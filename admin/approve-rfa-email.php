...
require_once __DIR__ . '/../vendor/autoload.php';  // Adjust path as necessary to include autoload.php
            ...
            <tr>
                <td style="padding: 20px; text-align: center; background-color: #ffffff;">
                    ...
                    <p style="font-size: 16px; margin-top: 20px;">
                        Your RFA Form has been <strong>approved</strong> by SEADO with the following Reference Number:
                    </p>
...
header("Location: ../admin/schedule-rfa-form.php");
