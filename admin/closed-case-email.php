...
// Load .env file from the admin folder
$dotenv = Dotenv\Dotenv::createImmutable(__DIR__);
$dotenv->load();

// Retrieve the API key from the environment variable
$sendinBlueApiKey = $_ENV['SENDINBLUE_API_KEY'] ?? null;
...
$sendSmtpEmail = new \SendinBlue\Client\Model\SendSmtpEmail([
    ...
    'sender' => ['name' => 'WAO Valenzuela', 'email' => 'waovalenzuela.gov.ph@gmail.com'],
    'replyTo' => ['name' => 'WAO Valenzuela', 'email' => 'waovalenzuela.gov.ph@gmail.com'],
    ...
    <body style="margin: 0; padding: 20px; background-color: #f4f4f4; font-family: Arial, sans-serif; color: #333;">
        ...
        <table width="100%" style="max-width: 600px; margin: 0 auto; background-color: white; border-radius: 8px;">
            ...
            <tr>
                <td style="padding: 20px; text-align: center; background-color: #ffffff;">
                    ...
                    <p style="font-size: 16px; margin-top: 20px;">
                        Your RFA Form has been <strong>completed</strong> by SEADO with the following Reference Number:
                    </p>
            ...
            <tr>
                <td style="padding: 20px; text-align: center; background-color: #ffffff;">
                    <a href="" style="display: inline-block; padding: 10px 20px; background-color: #d00000; color: white; text-decoration: none; border-radius: 5px; font-size: 16px;">
                        View Full Report
                    </a>
                </td>
            </tr>
...
header("Location: ../admin/history-logs.php"); // should redirect to rfa-entries and visible to new RFAs for admin side
