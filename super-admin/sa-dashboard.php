                ...
                <div class="col-md-4">
                    <div class="rectangle">
                        ...
                        <div class="d-flex justify-content-center align-items-center"> <!-- Flex container -->
                            ...
                            <img src="../assets/undraw/sa_new_entries.svg" alt="" style="max-width: 50%; padding-left: 10px; padding-top: 10%"> <!-- Add padding-left for spacing -->
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    <div class="rectangle">
                        ...
                        <div class="d-flex justify-content-center align-items-center"> <!-- Flex container -->
                            ...
                            <img src="../assets/undraw/sa_settled.svg" alt="" style="max-width: 55%; padding-left: 10px; padding-top: 34px"> <!-- Add padding-left for spacing -->
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="rectangle">
                        ...
                        <div class="d-flex justify-content-center align-items-center"> <!-- Flex container -->
                            <h1 class="display-1 fw-bold" style="margin-bottom: 0; padding-right: 38%">2</h1> <!-- Remove margin bottom for alignment -->
                            <img src="../assets/undraw/sa_agreement.svg" alt="" style="max-width: 160%; padding-left: 10px;"> <!-- Add padding-left for spacing -->
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="rectangle">
                        ...
                        <div class="d-flex justify-content-center align-items-center"> <!-- Flex container -->
                            ...
                            <img src="../assets/undraw/sa_referral.svg" alt="" style="max-width: 100%; padding-left: 10px;"> <!-- Add padding-left for spacing -->
                        </div>
                    </div>
                </div>
            </div>
