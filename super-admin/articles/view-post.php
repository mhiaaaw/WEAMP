...
<body>
   ...
   <div class="main-content">
      ...
      <section class="show-posts">
         <h1 class="post-heading">Your posts</h1>
         ...
         <div class="box-container">
            ...
            ?>
                  <form method="post" class="box-post">
                     ...
                     <div class="post-status" style="background-color:<?php
                     ...
                     <a href="../articles/read-post.php?postID=<?= $postID; ?>" class="post-btn">View post</a>
                  </form>
            <?php
               }
            } else {
               echo '<p class="empty">No posts added yet! <a href="../articles/add-post.php" class="post-btn" style="margin-top:1.5rem;">Add post</a></p>';
            }
            ?>
