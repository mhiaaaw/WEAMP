      ...
      <section class="post-editor">
         ...
         ?>
               <form action="" method="post" enctype="multipart/form-data">
                  ...
                  <input type="text" name="title" maxlength="100" required placeholder="Add post title" class="box-post" value="<?= htmlspecialchars($fetch_posts['postTitle']); ?>">

                  <p>Post Content <span>*</span></p>
                  <textarea name="content" class="box-post" required maxlength="20000" placeholder="Write your content..." cols="30" rows="10"><?= htmlspecialchars($fetch_posts['postContent']); ?></textarea>

                  <p>Post Link</p>
                  <input type="url" name="link" class="box-post" value="<?= htmlspecialchars($fetch_posts['postLink']); ?>">
